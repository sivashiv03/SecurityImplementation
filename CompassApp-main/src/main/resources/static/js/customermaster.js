$(document).ready(function () {
    ...
    if (localStorage["customerId"] !== "null" && localStorage["customerId"] !== "") {
        ...
        getAjaxReq('/capp/assessment/getCustomer/'+customerId).done(handleCustomerResponse);
    }
    ...
    function ajax_post() {
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json",
            url: "/capp/assessment/addCustomerAjax",
            data: search,
            dataType: "json",
            cache: false,
            timeout: 600000,
    ...
    $("#assementScopeWindow :checkbox").change(function (event) {
        ...
        if (this.checked) {
            ...
            $.ajax({
                type: "GET",
                contentType: "application/json",
                url: "/capp/assessment/getProcessByStream/" + streamName,
                data: "",
                dataType: "json",
                cache: false,
                timeout: 600000,
